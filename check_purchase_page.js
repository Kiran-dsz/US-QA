...
(async () => {
  ...
  try {
    ...
    await page.goto('https://test.theplaud.com/member/purchase?from=left_up', { waitUntil: 'networkidle2', timeout: 30000 });
    await delay(3000);
    ...
    // Take screenshot
    await page.screenshot({ path: '/tmp/purchase_page.png', fullPage: true });
    console.log('✅ Screenshot saved to /tmp/purchase_page.png');
